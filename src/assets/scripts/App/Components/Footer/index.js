      ...
      <div className="container">
        <div className="row">
          <div className="col-md-6 item text mb-5 order-md-3">
            ...
            <p>
              We are not undefined an electronic collective from Berlin,
              Germany. We make noise and beautiful things. For bookings or any
              other information you can send us an email to:
            </p>
            <p>
